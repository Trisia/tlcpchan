...
## 版权声明
本项目(tlcpchan)代码的版权归[Trisia](https://github.com/Trisia)所有，并按照[MIT](https://github.com/Trisia/tlcpchan/blob/main/LICENSE)进行分发。使用本项目的代码时，必须遵守相应的许可证条款。
...
6. **产品认证**
本项目(tlcpchan)**没有**经过相关机构（包括但不限于**国家密码管理局商用密码检测中心**）认证，也不承诺会进行相关认证工作。
